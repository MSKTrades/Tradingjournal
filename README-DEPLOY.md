...
(An earlier version of this delivery had a "Position Size %" card showing your highest/lowest position size used — swapped out for Total P/L per your last message, since with most accounts sizing a fixed % per trade that card just showed the same number twice and wasn't useful.)
